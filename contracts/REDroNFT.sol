    ...
    contract REDroNFT is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 2000000000000000; // 0.0019 ETH 
      uint256 public constant maxTokenPurchase = 3;
      uint256 public constant MAX_TOKENS = 17;
    
      string public baseURI = "ipfs://QmeNcqEtNSbAAqSQK5hK9GwCUw3zmf4Bfc4nSL6dGM4Yo5/"; // IPFS URI WILL BE SET AFTER ALL TOKENS SOLD OUT
      ...
      event CuberiumMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("CuberiumNFT", "nCBR") {}
      ...
      function mintCuberium(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit CuberiumMinted(id, msg.sender);
          }
        }
      }
    
      function presaleCuberium(uint256 numberOfTokens) external payable {
